...
execute store result score @e[type=zombie,tag=NewProjectile,limit=1] Dummy run attribute @e[type=#rpgpve:has_health_bar,tag=FireMage,sort=nearest,limit=1] generic.attack_damage get
