...
execute if score #MusicLoop Dummy matches 2900.. run function rpgpve:game/battle_wave/loop_music
...
execute store result score #MobsResting Dummy if entity @e[type=#rpgpve:has_health_bar,tag=RPGPVEMob]
execute store result score #ParticlesResting Dummy if entity @e[type=marker,tag=MonsterSpawnParticle]
execute unless score #BossFight Dummy matches 1 if score #MobsResting Dummy matches 0 if score #ParticlesResting Dummy matches 0 run function rpgpve:game/battle_wave/killed_all_mobs

# Gold Telekinesis
execute as @e[type=item,predicate=rpgpve:new_gold] run function rpgpve:game/battle_wave/gold/new_gold

# Bosses
execute if score #BossFight Dummy matches 1 run function rpgpve:game/battle_wave/bosses/main
