...
playsound entity.ender_dragon.growl master @a[tag=IsInRPGPVEGame] ~ ~ ~ 0.5 0
stopsound @a * rpgpve:music.wave.battle
stopsound @a * rpgpve:music.wave.preparation

# Particles
execute as @a[tag=IsInRPGPVEGame] at @s run particle dust{color:[0.165d,0.341d,0.071d],scale:1} ~ ~0.6 ~ 1 1 1 0.1 60 force @s
execute as @a[tag=IsInRPGPVEGame] at @s run particle dragon_breath ~ ~0.6 ~ 1 1 1 0.1 60 force @s
#----------------------------------------#
