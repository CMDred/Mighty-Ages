...
particle block{block_state:{Name:"minecraft:ice"}} ~ ~1 ~ 0.5 1 0.5 0.1 30 normal
playsound block.glass.place master @a[distance=..30] ~ ~ ~ 0.5 1 0
summon armor_stand ~ ~ ~ {Tags:["Freeze","NewFreeze"],NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:turtle_scute",Count:1b,components:{"minecraft:custom_model_data":5}}]}
