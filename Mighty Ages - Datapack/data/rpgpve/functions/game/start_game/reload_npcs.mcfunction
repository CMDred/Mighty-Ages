...
#========================================#
#---------------START GAME---------------#
execute in rpgpve:rpgpve_game positioned -600 56 0 store result score #Count Dummy if entity @a[tag=IsInRPGPVEGame,tag=!Eliminated,distance=..100]
execute if score #Count Dummy matches 2.. run return 0
...
execute in rpgpve:rpgpve_game positioned -632 57 0 unless entity @e[type=#rpgpve:npc_entities,tag=NPC,distance=..3] run function rpgpve:npcs/summon/terra_knight
...
execute in rpgpve:rpgpve_game positioned -608 56 22 unless entity @e[type=#rpgpve:npc_entities,tag=NPC,distance=..3] run function rpgpve:npcs/summon/golem
execute if score #CurrentBattleWave Dummy matches 20.. in rpgpve:rpgpve_game positioned -595 56 -28 run function rpgpve:npcs/summon/mage
#----------------------------------------#
