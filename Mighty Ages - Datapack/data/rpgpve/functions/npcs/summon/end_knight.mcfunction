...
execute positioned ~ ~1.7 ~ run data modify entity @e[type=text_display,tag=NPCClick,limit=1,sort=nearest] text set value '{"text":"Click to buy Gadgets and Blessings!","color":"gray","underlined":true}'

scoreboard players set @e[tag=NPC.New,sort=nearest,limit=1] Menus.Page 20
tag @e[tag=NPC.New,sort=nearest,limit=1] add NPC.EndKnight
