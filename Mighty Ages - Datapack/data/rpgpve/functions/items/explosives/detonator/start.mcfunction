...
scoreboard players set #MotSpeed Dummy 360

execute store result score #rand Dummy run random value 60..100

scoreboard players operation @e[type=armor_stand,tag=NewExplosive] Attack1Delay = #rand Dummy
