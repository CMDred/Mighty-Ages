...
scoreboard players operation #Delay Dummy = @s Attack1Delay
scoreboard players operation #Delay Dummy -= @s Attack1Timer

execute in overworld run setblock 700000 1 700000 oak_sign{front_text:{messages:['[{"score":{"name":"#Delay","objective": "Dummy"},"color":"dark_red","italic":false,"bold":true}]','{"text":""}','{"text":""}','{"text":""}']}} 
