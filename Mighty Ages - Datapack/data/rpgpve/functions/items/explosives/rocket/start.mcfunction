summon zombie ~ ~1.62 ~ {Silent:1b,NoAI:1b,active_effects:[{id:"minecraft:invisibility",duration:1b,duration:99999,show_particles:0b},{id:"minecraft:invisibility",duration:1b,duration:99999,show_particles:0b}],Tags:["DontRegister","NewExplosive","ExplosiveEntity","Rocket","Motion_target"],NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:warped_fungus_on_a_stick",Count:1b}]}
