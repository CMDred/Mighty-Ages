...
$execute if score #Gold Dummy >= #Cost Dummy as @p[tag=MenuOwner] run function rpgpve:items/buy/other/success {Type: $(Type), Display: "$(Display)", ID: $(ID), ParentFolder:"healing"}
