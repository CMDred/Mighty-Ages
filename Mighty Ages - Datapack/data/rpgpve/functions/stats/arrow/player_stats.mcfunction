...
#---------------BASIC STATS----------------#
execute store result score @s DamageTypeArrow run data get storage rpgpve:damage Bow.components."minecraft:custom_data".RPG.DamageType
execute if score @s DamageTypeArrow matches 0 run scoreboard players set @s DamageTypeArrow 1

execute store result score @s ArrowDamage run data get storage rpgpve:damage Bow.components."minecraft:custom_data".RPG.Damage
...
#---------------BOW EFFECTS----------------#
execute if data storage rpgpve:damage Bow.components."minecraft:custom_data".RPG{Ability:"Poison"} run tag @s add PoisonArrow
execute if data storage rpgpve:damage Bow.components."minecraft:custom_data".RPG{Ability:"Punch"} run tag @s add PunchArrow
execute if data storage rpgpve:damage Bow.components."minecraft:custom_data".RPG{Ability:"Flame"} run data modify entity @s Fire set value 2000s
#------------------SETUP-------------------#
