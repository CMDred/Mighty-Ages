...
scoreboard players reset #base_number Dummy
execute if score #FinalDamage Dummy matches 1000.. run scoreboard players operation #base_number Dummy = #FinalDamage Dummy
execute if score #FinalDamage Dummy matches 1000.. run function rpgpve:split_comma_numbers/begin
