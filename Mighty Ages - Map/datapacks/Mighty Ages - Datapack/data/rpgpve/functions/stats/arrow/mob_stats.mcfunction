#------------------SETUP-------------------#
execute store result score @s ArrowDamage run scoreboard players get @e[type=#rpgpve:has_health_bar,type=#rpgpve:has_health_bar,tag=RPGPVEMob,sort=nearest,limit=1] Damage
