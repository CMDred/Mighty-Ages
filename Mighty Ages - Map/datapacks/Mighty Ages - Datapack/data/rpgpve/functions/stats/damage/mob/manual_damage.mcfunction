...
execute if score #AttackerExists Temp matches 0 at @s positioned ~ ~1 ~ run summon minecraft:text_display ^ ^ ^1.5 {Tags:["KillTimer","DamageDealt","DamageDealtNew"],billboard:"center",billboard:"center",width:2f,height:0.5f,view_range:0.25f}
