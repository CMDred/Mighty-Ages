execute if score @s EatGapple matches 1.. run function rpgpve:items/gapple/eat
execute if score @s GappleTimer matches 1.. run scoreboard players remove @s GappleTimer 1
execute if score @s GappleTimer matches 1 run function rpgpve:items/gapple/end
