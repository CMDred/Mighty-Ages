...
execute positioned ~ ~1.7 ~ run data modify entity @e[type=armor_stand,limit=1,sort=nearest,tag=NPCClick] CustomName set value '{"text":"Click to purchase Weapons!","color":"gray","underlined":true}'
scoreboard players set @e[type=armor_stand,tag=LookMenuAS,sort=nearest,limit=1] M_LookMenuPage 1
#------------------------------------------#
