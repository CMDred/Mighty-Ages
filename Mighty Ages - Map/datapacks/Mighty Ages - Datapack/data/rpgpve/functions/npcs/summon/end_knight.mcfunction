...
execute positioned ~ ~1.7 ~ run data modify entity @e[type=text_display,tag=NPCClick,limit=1,sort=nearest] text set value '{"text":"Click to view Temporary Gadgets!","color":"gray","underlined":true}'
scoreboard players set @e[type=marker,tag=LookMenuAS,sort=nearest,limit=1] M_LookMenuPage 9
#------------------------------------------#
