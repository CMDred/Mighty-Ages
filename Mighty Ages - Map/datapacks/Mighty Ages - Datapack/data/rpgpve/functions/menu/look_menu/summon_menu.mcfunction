...
execute positioned ~ ~0.5 ~ run scoreboard players operation @e[type=chest_minecart,tag=NewMenu,distance=..1,limit=1,sort=nearest] M_CurrentPage = @e[type=armor_stand,tag=LookMenuAS,sort=nearest,limit=1] M_LookMenuPage
execute positioned ~ ~0.5 ~ run scoreboard players operation @e[type=chest_minecart,tag=NewMenu,distance=..1,limit=1,sort=nearest] M_LookMenuPage = @e[type=armor_stand,tag=LookMenuAS,sort=nearest,limit=1] M_LookMenuPage
