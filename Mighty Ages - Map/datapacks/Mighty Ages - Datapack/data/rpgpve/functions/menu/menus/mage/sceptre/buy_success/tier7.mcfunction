...
tellraw @s {"text":"You upgraded to Golden Shaman Sceptre!","color":"green"}
scoreboard players set @s MagicMeleePurchased 7
clear @s iron_shovel
loot give @s loot rpgpve:items/weapons/sceptres/tier7sceptre
