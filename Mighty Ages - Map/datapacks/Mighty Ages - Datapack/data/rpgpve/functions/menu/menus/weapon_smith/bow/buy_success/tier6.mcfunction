...
tellraw @s {"text":"You upgraded to Golden Bow!","color":"green"}
scoreboard players set @s PhysicRangedPurchased 6
clear @s bow
loot give @s loot rpgpve:items/weapons/bows/tier6bow
