...
tellraw @s {"text":"You upgraded to Spiny Stick!","color":"green"}
scoreboard players set @s PhysicMeleePurchased 2
clear @s stick
loot replace entity @s hotbar.0 loot rpgpve:items/weapons/swords/tier2sword
