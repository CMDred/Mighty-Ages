...
tellraw @s {"text":"You got the Wooden Sceptre!","color":"green"}
scoreboard players set @s MagicMeleePurchased 1
loot give @s loot rpgpve:items/weapons/sceptres/tier1sceptre
