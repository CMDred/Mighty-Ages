...
tellraw @s {"text":"You upgraded to Giant's Sceptre!","color":"green"}
scoreboard players set @s MagicMeleePurchased 4
clear @s stone_shovel
loot give @s loot rpgpve:items/weapons/sceptres/tier4sceptre
