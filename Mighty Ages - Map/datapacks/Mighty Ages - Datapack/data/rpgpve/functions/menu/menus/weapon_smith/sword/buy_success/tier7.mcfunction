...
tellraw @s {"text":"You upgraded to Golden Dagger!","color":"green"}
scoreboard players set @s PhysicMeleePurchased 7
clear @s stone_sword
loot replace entity @s hotbar.0 loot rpgpve:items/weapons/swords/tier7sword
