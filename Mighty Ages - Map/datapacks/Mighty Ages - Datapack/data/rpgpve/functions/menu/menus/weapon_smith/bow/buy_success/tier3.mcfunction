...
tellraw @s {"text":"You upgraded to Solid Shortbow!","color":"green"}
scoreboard players set @s PhysicRangedPurchased 3
clear @s bow
loot give @s loot rpgpve:items/weapons/bows/tier3bow
