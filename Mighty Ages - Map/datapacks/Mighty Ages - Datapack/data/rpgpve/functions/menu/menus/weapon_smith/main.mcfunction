...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:11b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 2
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:15b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 5
...
loot replace entity @s container.0 loot rpgpve:menu/weaponsmith/infos
loot replace entity @s container.11 loot rpgpve:menu/weaponsmith/sword_menu_button
loot replace entity @s container.15 loot rpgpve:menu/weaponsmith/bow_menu_button
