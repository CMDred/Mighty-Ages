...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:9b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 2
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:17b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 4

execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:10b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/weapon_smith/sword/try_buy/tier5
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:12b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/weapon_smith/sword/try_buy/tier6
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:14b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/weapon_smith/sword/try_buy/tier7
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:16b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/weapon_smith/sword/try_buy/tier8
...
# Weapons
# Tier 5
loot replace entity @s container.10 loot rpgpve:items/weapons/swords/tier5sword
...
# Tier 6
loot replace entity @s container.12 loot rpgpve:items/weapons/swords/tier6sword
...
# Tier 7
loot replace entity @s container.14 loot rpgpve:items/weapons/swords/tier7sword
...
# Tier 8
loot replace entity @s container.16 loot rpgpve:items/weapons/swords/tier8sword
