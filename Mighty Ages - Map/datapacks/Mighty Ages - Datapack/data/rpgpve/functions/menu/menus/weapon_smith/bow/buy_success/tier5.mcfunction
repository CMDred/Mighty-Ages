...
tellraw @s {"text":"You upgraded to Starfire Shot!","color":"green"}
scoreboard players set @s PhysicRangedPurchased 5
clear @s bow
loot give @s loot rpgpve:items/weapons/bows/tier5bow
