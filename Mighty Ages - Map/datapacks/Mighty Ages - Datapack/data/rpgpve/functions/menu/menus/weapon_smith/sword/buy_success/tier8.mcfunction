...
tellraw @s {"text":"You upgraded to Golden Order's Sword!","color":"green"}
scoreboard players set @s PhysicMeleePurchased 8
clear @s golden_sword
loot replace entity @s hotbar.0 loot rpgpve:items/weapons/swords/tier8sword
