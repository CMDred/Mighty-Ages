...
tellraw @s {"text":"You upgraded to Wooden Blade!","color":"green"}
scoreboard players set @s PhysicMeleePurchased 3
clear @s stick
loot replace entity @s hotbar.0 loot rpgpve:items/weapons/swords/tier3sword
