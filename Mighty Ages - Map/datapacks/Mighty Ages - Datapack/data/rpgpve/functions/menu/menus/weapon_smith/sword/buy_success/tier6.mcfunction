...
tellraw @s {"text":"You upgraded to Whetted Stone Chunk!","color":"green"}
scoreboard players set @s PhysicMeleePurchased 6
clear @s stone_sword
loot replace entity @s hotbar.0 loot rpgpve:items/weapons/swords/tier6sword
