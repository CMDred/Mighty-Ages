...
#==========================================#
#-----------------BUTTONS------------------#
data merge entity @s {CustomName:'{"text":"mage"}'}
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:18b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 14
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:17b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 16

execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:10b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/sceptre/try_buy/tier1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:12b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/sceptre/try_buy/tier2
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:14b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/sceptre/try_buy/tier3
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:16b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/sceptre/try_buy/tier4
...
loot replace entity @s container.17 loot rpgpve:menu/next_arrow
loot replace entity @s container.18 loot rpgpve:menu/back_arrow
...
# Weapons
# Tier 1
loot replace entity @s container.10 loot rpgpve:items/weapons/sceptres/tier1sceptre
...
scoreboard players set #Style Temp 1
data modify storage rpgpve:mage MenuItem set from entity @s Items[{Slot:10b}]
function rpgpve:menu/menus/mage/get_item
data modify entity @s Items[{Slot:10b}] set from storage rpgpve:mage MenuItem
data modify entity @s Items[{Slot:0b}].tag.Costs append from storage rpgpve:mage MenuItem.tag.RPG.GoldCost

# Tier 2
loot replace entity @s container.12 loot rpgpve:items/weapons/sceptres/tier2sceptre
data modify entity @s Items[{Slot:12b}].tag.MenuItem set value 1b
scoreboard players set #Tier Temp 2
scoreboard players set #Type Temp 2
scoreboard players set #Style Temp 1
data modify storage rpgpve:mage MenuItem set from entity @s Items[{Slot:12b}]
function rpgpve:menu/menus/mage/get_item
data modify entity @s Items[{Slot:12b}] set from storage rpgpve:mage MenuItem
data modify entity @s Items[{Slot:0b}].tag.Costs append from storage rpgpve:mage MenuItem.tag.RPG.GoldCost

# Tier 3
loot replace entity @s container.14 loot rpgpve:items/weapons/sceptres/tier3sceptre
data modify entity @s Items[{Slot:14b}].tag.MenuItem set value 1b
scoreboard players set #Tier Temp 3
scoreboard players set #Type Temp 2
scoreboard players set #Style Temp 1
data modify storage rpgpve:mage MenuItem set from entity @s Items[{Slot:14b}]
function rpgpve:menu/menus/mage/get_item
data modify entity @s Items[{Slot:14b}] set from storage rpgpve:mage MenuItem
data modify entity @s Items[{Slot:0b}].tag.Costs append from storage rpgpve:mage MenuItem.tag.RPG.GoldCost

# Tier 4
loot replace entity @s container.16 loot rpgpve:items/weapons/sceptres/tier4sceptre
data modify entity @s Items[{Slot:16b}].tag.MenuItem set value 1b
scoreboard players set #Tier Temp 4
scoreboard players set #Type Temp 2
scoreboard players set #Style Temp 1
data modify storage rpgpve:mage MenuItem set from entity @s Items[{Slot:16b}]
function rpgpve:menu/menus/mage/get_item
data modify entity @s Items[{Slot:16b}] set from storage rpgpve:mage MenuItem
data modify entity @s Items[{Slot:0b}].tag.Costs append from storage rpgpve:mage MenuItem.tag.RPG.GoldCost
#------------------------------------------#