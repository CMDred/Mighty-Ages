...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:18b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:17b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 3

execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:10b,tag:{MenuItem:1b}}]}] as @a[tag=ThisPlayer] at @s run function rpgpve:menu/menus/weapon_smith/error2
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:12b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/weapon_smith/sword/try_buy/tier2
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:14b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/weapon_smith/sword/try_buy/tier3
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:16b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/weapon_smith/sword/try_buy/tier4
...
# Weapons
# Tier 1
loot replace entity @s container.10 loot rpgpve:items/weapons/swords/tier1sword
data modify entity @s Items[{Slot:10b}].tag.MenuItem set value 1b
data modify entity @s Items[{Slot:10b}].tag.display.Lore append value '{"text":""}'
data modify entity @s Items[{Slot:10b}].tag.display.Lore append value '{"text":"You own this weapon!","color":"green","italic":false,"underlined":true}'
data modify entity @s Items[{Slot:10b}].tag.Enchantments set value [{id:"minecraft:power",level:1s}]
data modify entity @s Items[{Slot:0b}].tag.Costs append value 0

# Tier 2
loot replace entity @s container.12 loot rpgpve:items/weapons/swords/tier2sword
...
# Tier 3
loot replace entity @s container.14 loot rpgpve:items/weapons/swords/tier3sword
...
# Tier 4
loot replace entity @s container.16 loot rpgpve:items/weapons/swords/tier4sword
