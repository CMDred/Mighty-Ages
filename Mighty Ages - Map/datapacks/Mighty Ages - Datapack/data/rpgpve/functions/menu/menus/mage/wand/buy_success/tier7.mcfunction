...
tellraw @s {"text":"You upgraded to Catastrophe!","color":"green"}
scoreboard players set @s MagicRangedPurchased 7
clear @s warped_fungus_on_a_stick{RPG:{DamageType:2}}
loot give @s loot rpgpve:items/weapons/wands/tier7wand
