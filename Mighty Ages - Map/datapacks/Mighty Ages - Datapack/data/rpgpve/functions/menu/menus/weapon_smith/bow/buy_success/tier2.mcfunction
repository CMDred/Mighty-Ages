...
tellraw @s {"text":"You upgraded to Shortbow!","color":"green"}
scoreboard players set @s PhysicRangedPurchased 2
clear @s bow
loot give @s loot rpgpve:items/weapons/bows/tier2bow
