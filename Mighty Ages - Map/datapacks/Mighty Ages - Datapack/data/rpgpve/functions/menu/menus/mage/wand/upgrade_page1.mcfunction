...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:17b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 19

execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:10b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/wand/try_buy/tier1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:12b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/wand/try_buy/tier2
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:14b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/wand/try_buy/tier3
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:16b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/wand/try_buy/tier4
...
# Weapons
# Tier 2
loot replace entity @s container.10 loot rpgpve:items/weapons/wands/tier1wand
...
# Tier 2
loot replace entity @s container.12 loot rpgpve:items/weapons/wands/tier2wand
...
# Tier 3
loot replace entity @s container.14 loot rpgpve:items/weapons/wands/tier3wand
...
# Tier 4
loot replace entity @s container.16 loot rpgpve:items/weapons/wands/tier4wand
