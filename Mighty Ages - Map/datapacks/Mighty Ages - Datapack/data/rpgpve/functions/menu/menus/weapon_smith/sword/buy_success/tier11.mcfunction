...
tellraw @s {"text":"You upgraded to Burning Rock Sword!","color":"green"}
scoreboard players set @s PhysicMeleePurchased 11
clear @s diamond_sword
loot replace entity @s hotbar.0 loot rpgpve:items/weapons/swords/tier11sword
