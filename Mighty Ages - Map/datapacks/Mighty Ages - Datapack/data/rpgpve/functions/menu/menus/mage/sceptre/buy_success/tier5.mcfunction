...
tellraw @s {"text":"You upgraded to Steel Sceptre!","color":"green"}
scoreboard players set @s MagicMeleePurchased 5
clear @s stone_shovel
loot give @s loot rpgpve:items/weapons/sceptres/tier5sceptre
