...
tellraw @s {"text":"You upgraded to Sceptre of the Stars!","color":"green"}
scoreboard players set @s MagicMeleePurchased 10
clear @s diamond_shovel
loot give @s loot rpgpve:items/weapons/sceptres/tier10sceptre
