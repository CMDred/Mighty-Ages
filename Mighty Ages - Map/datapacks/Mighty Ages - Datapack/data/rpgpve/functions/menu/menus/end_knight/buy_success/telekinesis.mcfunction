...
#==========================================#
#-----------------BUTTONS------------------#
scoreboard players set @s GoldTelekinesis 1

scoreboard players operation @s GoldTelekinesisCost *= #c115 Constant
scoreboard players operation @s GoldTelekinesisCost /= #c100 Constant

tellraw @s ["",{"text":"You bought ","color":"green"},{"text":"Gold Telekinesis","color":"light_purple"},{"text":"!","color":"green"}]
