...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:9b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 16

execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:10b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/sceptre/try_buy/tier9
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:12b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/sceptre/try_buy/tier10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:14b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/sceptre/try_buy/tier11
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:16b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/mage/sceptre/try_buy/tier12
...
# Weapons
# Tier 9
loot replace entity @s container.10 loot rpgpve:items/weapons/sceptres/tier9sceptre
data modify entity @s Items[{Slot:10b}].tag.MenuItem set value 1b
scoreboard players set #Tier Temp 9
...
# Tier 10
loot replace entity @s container.12 loot rpgpve:items/weapons/sceptres/tier10sceptre
data modify entity @s Items[{Slot:12b}].tag.MenuItem set value 1b
scoreboard players set #Tier Temp 10
scoreboard players set #Type Temp 2
scoreboard players set #Style Temp 1
...
# Tier 11
loot replace entity @s container.14 loot rpgpve:items/weapons/sceptres/tier11sceptre
data modify entity @s Items[{Slot:14b}].tag.MenuItem set value 1b
scoreboard players set #Tier Temp 11
scoreboard players set #Type Temp 2
scoreboard players set #Style Temp 1
...
# Tier 12
loot replace entity @s container.16 loot rpgpve:items/weapons/sceptres/tier12sceptre
data modify entity @s Items[{Slot:16b}].tag.MenuItem set value 1b
scoreboard players set #Tier Temp 12
scoreboard players set #Type Temp 2
scoreboard players set #Style Temp 1
