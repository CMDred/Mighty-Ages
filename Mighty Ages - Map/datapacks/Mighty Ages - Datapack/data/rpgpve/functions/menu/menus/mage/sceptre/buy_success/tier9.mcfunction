...
tellraw @s {"text":"You upgraded to Sculk Sceptre!","color":"green"}
scoreboard players set @s MagicMeleePurchased 9
clear @s golden_shovel
loot give @s loot rpgpve:items/weapons/sceptres/tier9sceptre
