...
scoreboard players operation @s SpeedCost *= #c120 Constant
scoreboard players operation @s SpeedCost /= #c100 Constant

tellraw @s ["",{"text":"You bought ","color":"green"},{"text":"Speed","color":"aqua"},{"text":"!","color":"green"}]
