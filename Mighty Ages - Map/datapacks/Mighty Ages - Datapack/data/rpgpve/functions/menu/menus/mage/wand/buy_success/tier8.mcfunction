...
tellraw @s {"text":"You upgraded to Oblivion!","color":"green"}
scoreboard players set @s MagicRangedPurchased 8
clear @s warped_fungus_on_a_stick{RPG:{DamageType:2}}
loot give @s loot rpgpve:items/weapons/wands/tier8wand
