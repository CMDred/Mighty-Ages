...
tellraw @s {"text":"You upgraded to Oblivia's Sceptre!","color":"green"}
scoreboard players set @s MagicMeleePurchased 12
clear @s netherite_shovel
loot give @s loot rpgpve:items/weapons/sceptres/tier12sceptre
