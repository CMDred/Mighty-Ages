...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:11b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 15
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:15b,tag:{MenuItem:1b}}]}] run scoreboard players set @s M_NewPage 18
...
loot replace entity @s container.0 loot rpgpve:menu/mage/infos
loot replace entity @s container.11 loot rpgpve:menu/mage/sceptre_menu_button
loot replace entity @s container.15 loot rpgpve:menu/mage/wand_menu_button
