...
tellraw @s {"text":"You upgraded to Stalk of Truth!","color":"green"}
scoreboard players set @s MagicRangedPurchased 6
clear @s warped_fungus_on_a_stick{RPG:{DamageType:2}}
loot give @s loot rpgpve:items/weapons/wands/tier6wand
