...
#==========================================#
#-----------------BUTTONS------------------#
data merge entity @s {CustomName:'{"text":"Buy Explosives"}'}
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:11b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/scientist/try_buy/tiny_tnt
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:13b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/scientist/try_buy/detonator
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot:15b,tag:{MenuItem:1b}}]}] run function rpgpve:menu/menus/scientist/try_buy/rocket
...
loot replace entity @s container.0 loot rpgpve:menu/scientist/infos
...
data modify entity @s Items[0].tag.Costs set value [0,0,0]


loot replace entity @s container.11 loot rpgpve:items/utilities/explosives/tiny_tnt
scoreboard players operation #Cost Temp = @a[tag=ThisPlayer,limit=1] TinyTntCost
data modify entity @s Items[{Slot:11b}].tag.MenuItem set value 1b
data modify storage rpgpve:scientist MenuItem set from entity @s Items[{Slot:11b}]
function rpgpve:menu/menus/scientist/get_cost
data modify entity @s Items[{Slot:11b}] set from storage rpgpve:scientist MenuItem
execute store result entity @s Items[0].tag.Costs[0] int 1 run scoreboard players get #Cost Temp

loot replace entity @s container.13 loot rpgpve:items/utilities/explosives/detonator
scoreboard players operation #Cost Temp = @a[tag=ThisPlayer,limit=1] DetonatorCost
data modify entity @s Items[{Slot:13b}].tag.MenuItem set value 1b
data modify storage rpgpve:scientist MenuItem set from entity @s Items[{Slot:13b}]
function rpgpve:menu/menus/scientist/get_cost
data modify entity @s Items[{Slot:13b}] set from storage rpgpve:scientist MenuItem
execute store result entity @s Items[0].tag.Costs[1] int 1 run scoreboard players get #Cost Temp

loot replace entity @s container.15 loot rpgpve:items/utilities/explosives/rocket
scoreboard players operation #Cost Temp = @a[tag=ThisPlayer,limit=1] RocketCost
data modify entity @s Items[{Slot:15b}].tag.MenuItem set value 1b
data modify storage rpgpve:scientist MenuItem set from entity @s Items[{Slot:15b}]
function rpgpve:menu/menus/scientist/get_cost
data modify entity @s Items[{Slot:15b}] set from storage rpgpve:scientist MenuItem
