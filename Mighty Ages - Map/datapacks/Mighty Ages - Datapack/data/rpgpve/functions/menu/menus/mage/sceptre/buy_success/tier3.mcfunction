...
tellraw @s {"text":"You upgraded to Sculptor Sceptre!","color":"green"}
scoreboard players set @s MagicMeleePurchased 3
clear @s wooden_shovel
loot give @s loot rpgpve:items/weapons/sceptres/tier3sceptre
