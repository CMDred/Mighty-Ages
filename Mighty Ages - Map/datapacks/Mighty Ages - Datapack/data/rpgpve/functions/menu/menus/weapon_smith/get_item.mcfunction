...
execute if score #TierDifference Temp matches 2.. run data modify storage rpgpve:weaponsmith MenuItem.id set value "minecraft:coal"
# ----- Get item name with tier difference -----
## if difference is greater or equal to 2, then say "Unkown Item".
## else, don't change name.
execute if score #TierDifference Temp matches 2.. run data modify storage rpgpve:weaponsmith MenuItem.tag.display.Name set value '{"text":"Unkown Item","color":"yellow","italic":false}'
...
execute if score #TierDifference Temp matches 2.. run data modify storage rpgpve:weaponsmith MenuItem.tag.display.Lore set value ['{"text":"Buy the previous level to discover!","color":"gray","italic":false}']
execute if score #TierDifference Temp matches 1 run function rpgpve:menu/menus/weapon_smith/get_cost
execute if score #TierDifference Temp matches ..0 run data modify storage rpgpve:weaponsmith MenuItem.tag.display.Lore append value '{"text":""}'
execute if score #TierDifference Temp matches ..0 run data modify storage rpgpve:weaponsmith MenuItem.tag.display.Lore append value '{"text":"You own this weapon!","color":"green","italic":false,"underlined":true}'
# ----- Extra NBT -----
## if difference is less or equal to 0, add enchant glint
execute if score #TierDifference Temp matches ..0 run data modify storage rpgpve:weaponsmith MenuItem.tag.Enchantments set value [{id:"minecraft:power",level:1s}]
#------------------------------------------#