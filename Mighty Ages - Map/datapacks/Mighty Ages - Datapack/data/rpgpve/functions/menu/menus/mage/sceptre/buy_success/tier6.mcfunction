...
tellraw @s {"text":"You upgraded to White Gypstunite Sceptre!","color":"green"}
scoreboard players set @s MagicMeleePurchased 6
clear @s iron_shovel
loot give @s loot rpgpve:items/weapons/sceptres/tier6sceptre
