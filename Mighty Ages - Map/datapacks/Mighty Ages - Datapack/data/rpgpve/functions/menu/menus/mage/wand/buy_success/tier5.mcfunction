...
tellraw @s {"text":"You upgraded to Stormguard Staff!","color":"green"}
scoreboard players set @s MagicRangedPurchased 5
clear @s warped_fungus_on_a_stick{RPG:{DamageType:2}}
loot give @s loot rpgpve:items/weapons/wands/tier5wand
