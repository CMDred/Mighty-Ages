...
tellraw @s {"text":"You upgraded to Burning Death!","color":"green"}
scoreboard players set @s PhysicRangedPurchased 8
clear @s bow
loot give @s loot rpgpve:items/weapons/bows/tier8bow
