...
execute as @a at @s positioned ~ ~1.62 ~ if entity @e[type=marker,tag=LookMenuAS,distance=..6] run function rpgpve:menu/look_menu/look_check
execute as @a[tag=LookMenuOpen] at @s unless entity @e[type=marker,tag=LookMenuAS,distance=..6] run function rpgpve:menu/look_menu/close
#------------------MENUS-------------------#
...
execute as @e[type=item,predicate=rpgpve:is_menu_item] at @s run function rpgpve:menu/menu_item_thrown
#------------------------------------------#