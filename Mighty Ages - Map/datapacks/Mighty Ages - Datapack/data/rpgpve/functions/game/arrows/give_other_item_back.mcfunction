...
execute in minecraft:overworld run setblock 700000 1 700000 yellow_shulker_box{CustomName:'"Rpg Item Return"',Items:[{Slot:0b,id:"minecraft:wheat_seeds",Count:1b,tag:{MenuItem:1b}}]}
