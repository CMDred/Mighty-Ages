...
execute as @e[type=marker,tag=GeomancerSpikePos,tag=Summoning,tag=!Stop] at @s run particle block minecraft:stone ~ ~ ~ 0.7 0 0.7 0.1 10 force
...
execute as @e[type=marker,tag=GeomancerSpikePos,tag=Stop,scores={Attack2Timer=60..}] at @s run particle block minecraft:stone ~ ~ ~ 0.7 0 0.7 0.1 10 force
