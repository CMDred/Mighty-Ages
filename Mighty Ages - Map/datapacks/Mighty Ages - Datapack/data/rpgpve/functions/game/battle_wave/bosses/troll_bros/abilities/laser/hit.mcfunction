...
#========================================#
#-----------------BOSSES-----------------#
scoreboard players operation #FinalDamage Temp = @e[type=giant,tag=TrollBroX,distance=..100,limit=1] BaseMagicDamage

scoreboard players set @s DamageType 102
damage @s 0.001 rpgpve:manual_damage by @e[type=giant,tag=TrollBroX,distance=..100,limit=1]
