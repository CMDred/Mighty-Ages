...
execute if score #Reach Temp matches 1.. positioned ^ ^ ^0.5 if block ~ ~ ~ #rpgpve:allowed run function rpgpve:game/battle_wave/bosses/spectral_devourer/death_triangle/damage_raycast
#----------------------------------------#
