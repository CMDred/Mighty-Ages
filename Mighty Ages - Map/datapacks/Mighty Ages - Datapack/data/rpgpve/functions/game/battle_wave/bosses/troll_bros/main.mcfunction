...
execute if score #BossFightTimer Temp matches 411.. if score #BossSpawned Temp matches 1 if score #DeathTimer Temp matches 3 as @a[tag=IsInRPGPVEGame] at @s run function rpgpve:game/battle_wave/bosses/troll_bros/tellraws/death/both/1
execute if score #BossFightTimer Temp matches 411.. if score #BossSpawned Temp matches 1 if score #DeathTimer Temp matches 35 as @a[tag=IsInRPGPVEGame] at @s run function rpgpve:game/battle_wave/bosses/troll_bros/tellraws/death/both/2
execute if score #BossFightTimer Temp matches 411.. if score #BossSpawned Temp matches 1 if score #DeathTimer Temp matches 95 as @a[tag=IsInRPGPVEGame] at @s run function rpgpve:game/battle_wave/bosses/troll_bros/tellraws/death/both/3
