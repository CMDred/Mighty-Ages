...
#========================================#
#-----------------BOSSES-----------------#
execute if score @s Date matches ..0 store result score #RNG Temp run random value 1..4
execute if score @s Date matches ..0 if score #RNG Temp matches 1 as @a[tag=IsInRPGPVEGame] run function rpgpve:game/battle_wave/bosses/nether_lord/tellraws/abilities/fireball/random
