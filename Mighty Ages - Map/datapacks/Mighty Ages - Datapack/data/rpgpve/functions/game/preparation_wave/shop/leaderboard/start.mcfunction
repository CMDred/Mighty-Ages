...
execute store result score #Count Temp if entity @a[tag=IsInRPGPVEGame]
execute if score #Count Temp matches 1 run tellraw @s ["",{"text":"\n--------- YOUR KILLS ----------","color":"light_purple","bold":true}]
execute if score #Count Temp matches 1 run tellraw @s ["",{"selector":"@s","color":"white"},{"text":" - ","color":"white"},{"score":{"name": "@s","objective": "TotalKills"},"color":"gold"}]
execute if score #Count Temp matches 1 run tellraw @s ["",{"text":"------------------------------","color":"light_purple","bold":true}]
execute if score #Count Temp matches 1 run return 0
