...
execute if score #CooldownSeconds Temp matches 3 as @a[tag=IsInRPGPVELobby] at @s run playsound block.note_block.hat master @s ~ ~ ~ 1 0.3 1 
execute if score #CooldownSeconds Temp matches 2 as @a[tag=IsInRPGPVELobby] at @s run playsound block.note_block.hat master @s ~ ~ ~ 1 0.2 1 
execute if score #CooldownSeconds Temp matches 1 as @a[tag=IsInRPGPVELobby] at @s run playsound block.note_block.hat master @s ~ ~ ~ 1 0.1 1 
